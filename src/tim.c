...
void TIM1_Init(void)
{
    ...
    LL_TIM_SetTriggerInput(TIM1, LL_TIM_TS_ITR6);//LL_TIM_TS_ITR6
    ...
    TIM_OC_InitStruct.CompareValue = 99;//TIM1_AUTORELOAD / 2;
...
void TIM2_Init(void)
{
    ...
    LL_TIM_ConfigETR(TIM2, LL_TIM_ETR_POLARITY_NONINVERTED, LL_TIM_ETR_PRESCALER_DIV1, LL_TIM_ETR_FILTER_FDIV2_N8);
    ...
    TIM_OC_InitStruct.OCState = LL_TIM_OCSTATE_DISABLE;
    TIM_OC_InitStruct.OCNState = LL_TIM_OCSTATE_DISABLE;
    TIM_OC_InitStruct.CompareValue = NS_TO_TICKS(58000);;
    TIM_OC_InitStruct.OCPolarity = LL_TIM_OCPOLARITY_HIGH;
...
uint32_t HRTIM_reload[2] = {1000, 1000};
...
{ 
  ...
  LL_HRTIM_SetSyncInSrc(HRTIM1, LL_HRTIM_SYNCIN_SRC_NONE);
  ...
  //LL_HRTIM_EE_SetSensitivity(HRTIM1, LL_HRTIM_EVENT_1, LL_HRTIM_EE_SENSITIVITY_RISINGEDGE);
  ...
  LL_HRTIM_EE_SetPrescaler(HRTIM1, LL_HRTIM_EE_PRESCALER_DIV1);
  LL_HRTIM_EE_SetSrc(HRTIM1, LL_HRTIM_EVENT_9, LL_HRTIM_EEV9SRC_TIM15_TRGO);
  LL_HRTIM_EE_SetPolarity(HRTIM1, LL_HRTIM_EVENT_9, LL_HRTIM_EE_POLARITY_LOW);
  ...
  LL_HRTIM_TIM_SetCounterMode(HRTIM1, LL_HRTIM_TIMER_MASTER, LL_HRTIM_MODE_RETRIGGERABLE);
  LL_HRTIM_TIM_SetPeriod(HRTIM1, LL_HRTIM_TIMER_MASTER, 0xFFFD);
  ...
  LL_HRTIM_TIM_SetDACTrig(HRTIM1, LL_HRTIM_TIMER_MASTER, LL_HRTIM_DACTRIG_DACTRIGOUT_3);
  ...
  LL_HRTIM_TIM_SetPeriod(HRTIM1, LL_HRTIM_TIMER_A, 614);
  ...
  LL_HRTIM_TIM_SetCompare1(HRTIM1, LL_HRTIM_TIMER_A, 300);
  ...
  LL_HRTIM_OUT_SetOutputResetSrc(HRTIM1, LL_HRTIM_OUTPUT_TA1, LL_HRTIM_OUTPUTRESET_TIMPER);
  ...
  //LL_HRTIM_EnableDMAReq_REP(HRTIM1,LL_HRTIM_TIMER_A);
  //LL_HRTIM_EnableDMAReq_UPDATE(HRTIM1, LL_HRTIM_TIMER_A);
  //LL_HRTIM_EnableDMAReq_SET1(HRTIM1, LL_HRTIM_TIMER_A);
  //LL_HRTIM_EnableDMAReq_RST1(HRTIM1, LL_HRTIM_TIMER_A);
  LL_HRTIM_EnableDMAReq_REP(HRTIM1, LL_HRTIM_TIMER_A);
  //LL_HRTIM_EnableDMAReq_CMP1(HRTIM1, LL_HRTIM_TIMER_A);
  //LL_HRTIM_EnableDMAReq_CPT1(HRTIM1, LL_HRTIM_TIMER_A);

  HRTIM_reload[0] = HRTIM1->sMasterRegs.MCR;
  HRTIM_reload[1] = HRTIM1->sMasterRegs.MCR;

  
  LL_DMA_SetPeriphRequest(DMA2, LL_DMA_CHANNEL_5, LL_DMAMUX_REQ_TIM15_UP);
  ...
  LL_DMA_SetMemoryAddress(DMA2, LL_DMA_CHANNEL_5, (uint32_t)HRTIM_reload);     
  LL_DMA_SetPeriphAddress(DMA2, LL_DMA_CHANNEL_5, (uint32_t)&HRTIM1->sMasterRegs.MCR);
  LL_DMA_SetDataLength(DMA2, LL_DMA_CHANNEL_5, 2);
