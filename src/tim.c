...
{ 
  ...
  LL_DMA_SetPeriphRequest(DMA2, LL_DMA_CHANNEL_8, LL_DMAMUX_REQ_TIM1_UP);
  LL_DMA_SetDataTransferDirection(DMA2, LL_DMA_CHANNEL_8, LL_DMA_DIRECTION_MEMORY_TO_PERIPH);
  LL_DMA_SetPeriphAddress(DMA2, LL_DMA_CHANNEL_8, (uint32_t)&HRTIM1->sTimerxRegs[1].CMP1CxR);
  LL_DMA_SetChannelPriorityLevel(DMA2, LL_DMA_CHANNEL_8, LL_DMA_PRIORITY_HIGH);
  LL_DMA_SetMode(DMA2, LL_DMA_CHANNEL_8, LL_DMA_MODE_NORMAL);
  LL_DMA_SetPeriphIncMode(DMA2, LL_DMA_CHANNEL_8, LL_DMA_PERIPH_NOINCREMENT);
  LL_DMA_SetMemoryIncMode(DMA2, LL_DMA_CHANNEL_8, LL_DMA_MEMORY_INCREMENT);
  LL_DMA_SetPeriphSize(DMA2, LL_DMA_CHANNEL_8, LL_DMA_PDATAALIGN_WORD);
  LL_DMA_SetMemorySize(DMA2, LL_DMA_CHANNEL_8, LL_DMA_MDATAALIGN_WORD);  
  ...
  LL_HRTIM_TIM_SetCompare1(HRTIM1, LL_HRTIM_TIMER_A, 250);
  LL_HRTIM_TIM_SetCompare2(HRTIM1, LL_HRTIM_TIMER_A, 1227-250);
  ...
  LL_HRTIM_TIM_SetUpdateTrig(HRTIM1, LL_HRTIM_TIMER_B, LL_HRTIM_UPDATETRIG_RESET);
